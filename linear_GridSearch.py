...
def main():
    ...
    gs_linear_mean_iqr = model_select.GridSearchCV(pipe_linear_mean_iqr,
                                                   param_grid=grid_pipe_mean_linear,
                                                   scoring='f1_macro',
                                                   cv=5,
                                                   refit=True,
                                                   n_jobs=-1)
